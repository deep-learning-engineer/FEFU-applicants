...
def get_data(url, department, finance, data_students, count_place, orig):
...
def data_loading(finance, data_students, count_place, orig):
    ...
    for speciality in fefu_speciality:
        data_students, count_place = get_data(url_data, speciality, finance, data_students, count_place, orig)
...
def get_students_received(finance, students_received, count_place, data_students):
    """ Формирование DataFrame с поступившими абитуриентами """

    # Определяем поступивших абитуриентов на общих основаниях
    students_received = incoming_students('На общих основаниях', students_received, count_place, data_students)
...
if __name__ == "__main__":
    ...
    for finance in type_place:
        ...
        # Загрузим данные
        data_students, count_place = data_loading(finance, data_students, count_place, orig)
        # Удалим дубликаты
        ...
        students_received = get_students_received(finance, students_received, count_place, data_students)
